...
const TIMELINE_DATA = [
  ...
  { year: "2016–2021", role: "Founder & CEO", org: "Cardiac Advisory Company (iMMi Life)", desc: "Built a telemedicine platform enabling small hospitals to transmit ECGs to a virtual cardiologist committee. Deployed across India, Tanzania, and Malawi. Included in PM's national telemedicine initiative.", tag: "Entrepreneurship" },
  { year: "2020–Present", role: "PMU Head · Governing Council", org: "StartupTN · TiE Chennai", desc: "Led the Project Management Unit for the Periyar Social Justice Venture Lab under StartupTN. Conceptualized and led BMC and Ecosystem Value Creation programs at TiE Chennai, impacting 10,000+ entrepreneurs. Mentored 100+ SC/ST entrepreneurs.", tag: "Ecosystem" },
